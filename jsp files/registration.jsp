			...
			<div class="item">
				...
				<div class="signin">
						...
						<h2 class="sup" >Sign up</h2>
							...
							<form method="post" action="Registration" id="form" class="form" onsubmit="return validateForm() ">
              ...
              <div class="error" id="cityError" ></div></div>
							...
							<div class="form-group">
								...
								<input type="submit" name="signup" id="signup"
									...
									<a href="login.jsp" class="already">I am already
							member</a>
		 ...
		 document.getElementById("form").onsubmit = function (event) {
		      ...
		      if (!isGenderSelected) {
		       ...
		       if (country === "") {
		    	  ...
		    	  alert(" Indians only can use this app");
		    	   i=i*0;
	            	  event.preventDefault(); // Prevent the form from submitting
	            } 
	           ...
	           if (!isagree&&i==1) {
	            	 // document.getElementById("agreeError").innerHTML = "Accept the terms and conditions";
