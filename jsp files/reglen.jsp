...
<title>Sign Up for Lender </title>
...
#name{ margin-left:29px;}#email{ margin-left:30px;}#password{margin-left:9px;}
#country{ margin-left:15px;}#address{ margin-left:15px;}#contact{ margin-left:22px;}
#city{ margin-left:38px;}#state{ margin-left:33px;}#pincode{ margin-left:7px;}#contact{ margin-left:15px;}
.error{
color:red;font-size:15px;}#togglePassword{cursor:pointer;}
</style>
			...
			<div class="item">
				...
				<div class="signin">
						...
						<h2 class="sup" >Sign up</h2>
							...
							<form method="post" action="Reglen" id="form" class="form" onsubmit="return validateForm() ">
						...
						<div class="error" id="genderError" ></div>
							...
							<div class="form-group">
								...
								<label for="occupation">Amount</label>
								<input type="number"  name="app" id="app" placeholder="For Automatic Approval" >
              ...
              <div class="error" id="cityError" ></div></div>
							...
							<div class="form-group">
								...
								<input type="submit" name="signup" id="signup"
									...
									<a href="loginlen.jsp" class="already">I am already
							member</a>
...
$(document).ready(function() {
    $("#togglePassword").click(function() {
	    ...
	    var amountInput = document.getElementById('app');
	    ...
	    function validateIndianPhoneNumber(phoneNumber) {
		 ...
		 document.getElementById("form").onsubmit = function (event) {
		       ...
		       var amount= document.getElementById("app").value;
		      ...
		      if (!isGenderSelected) {
		       ...
		       if (country === "") {
	            ...
	            if (state === ""||state ==='Select a country first') {
		...
		document.addEventListener("DOMContentLoaded", function() {
    	    ...
    	    const amount = document.getElementById("app");
   ...
   event.preventDefault();
	            ...
	            // Check for at least one special character (e.g., !@#$%^&*)
    	            ...
    	            event.preventDefault(); // Prevent form submission
    	            app.focus(); // Focus on the empty input field
    	        }
