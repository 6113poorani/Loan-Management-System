...
<title>Sign In for Borrower </title>
	...
	<div class="main">
			<div class="item">
				<div class="signin">
						...
						<button class="signup"><a href="regbor.jsp" >Create an
							account</a></button>
					</div>

					<div class="submit-form">
						<h2 >Sign in</h2>
						<form method="post" action="Loginbor" class="form" onsubmit="return validateForm() ">
