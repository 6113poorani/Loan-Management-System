...
.un{margin-left:15.8%;}.sp{margin-left:14%;}.ge{margin-left:15%;}.em{ margin-left:15.9%;}.occ{ margin-left:12.5%;}
.cont{ margin-left:14.5%;}.ci{ margin-left:17%;}.st{ margin-left:16%;}.ad{ margin-left:14.5%;}.con{ margin-left:14.5%;}
...
<nav class="sidebar">
      ...
      <div class="menu-content">
        <ul class="menu-items">
          ...
          <li class="item">
            <a href="#pro">Lender Profile</a>
          </li>
          <li class="item">
            <a href="#req">Approved Loans</a>
          </li>
          <li class="item">
...
<img class="pic" src="images/len.avif">
           ...
           <h2>Lender Profile:</h2>
               ...
               <p class="th">Email<span class="em">: <%out.print(email); %></span></p>
                <p class="th">Contact<span class="con">: <% out.print(mob); %></span></p>
                        <p class="th" >For Chat(Lender)<span class="ch"> Click here:<a href="https://wa.me/<%out.print(mob);%>?hii..."><img class="wa" src="images/walogo.png"></a> </p>
                
                <p class="th">Address<span class="ad">: <% out.print(add); %></span></p>
                <p class="th">City<span class="ci">: <% out.print(city); %></span></p>
                 <p class="th">State<span class="st">: <% out.print(state); %></span></p>
              <p class="th">Country<span class="cont">:  <% out.print(cont); %></span></p>
               <p class="th">pin code<span class="sp">: <% out.print(pincode); %></span></p>
            </div>
            
<div class="ldet" id="req"><br><br><br>
...
String query="select * from users,borrower where users.id=borrower.bid";
...
try{
	...
	%><table  class="len" >
	 	 <tr ><td class="le" >Borrower Account Number</td><td class="le"  >: <%= rs.getInt(1)%></td></tr>

		 <tr ><td class="le">Borrower Name</td><td class="le">: <%= rs.getString(2)%></td></tr>
		  <tr ><td class="le">Borrower Gender</td><td class="le">: <%= rs.getString(4)%></td></tr>
		 
		  <tr ><td class="le">Borrower Occupation</td><td class="le">: <%= rs.getString(7)%></td></tr>
		 <tr ><td class="le">Borrower Email</td><td class="le">: <%= rs.getString(3)%></td></tr>
		 <tr ><td class="le">Borrower Contact</td><td class="le">: <%= rs.getString(13)%></td></tr>
		 ...
		 <tr ><td class="le">Borrower Address</td><td class="le">: <%= rs.getString(8)%></td></tr>
		  <tr ><td class="le">Borrower City</td><td class="le">: <%= rs.getString(9)%></td></tr>
		   <tr ><td class="le">Borrower State</td><td class="le">: <%= rs.getString(10)%></td></tr>
		 <tr ><td class="le">Borrower Country</td><td class="le">: <%= rs.getString(11)%></td></tr>
		  <tr ><td class="le">Borrower Pin Code</td><td class="le">: <%= rs.getString(12)%></td></tr>
		 ...
		 <tr ><td class="le">EMI</td><td class="le">: <%= rs.getString(21)%></td></tr>
		  <tr ><td class="le">Total no.of month need to pay</td><td class="le">: <%= rs.getString(22)%></td></tr>
