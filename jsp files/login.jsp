...
.error{color:red;font-size:15px;}#togglePassword{cursor:pointer;}
</style>
	...
	<div class="main">
			<div class="item">
				<div class="signin">
						...
						<button class="signup"><a href="registration.jsp" >Create an
							account</a></button>
					</div>

					<div class="submit-form">
						<h2 >Sign in</h2>
						<form method="post" action="Login" class="form" onsubmit="return validateForm() ">
							...
							<div class="form-group">
								...
								<input type="password" name="password" id="password" placeholder="Password" class="name" >
...
<input type="hidden" id="forgot" value="<%= request.getAttribute("forgot")%>">
